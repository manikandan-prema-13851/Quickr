...
#define MBEDTLS_OID_PKCS1_SHA1_OIW      "\x2b" "\x0e" "\x03" "\x02" "\x1d" /**< sha1WithRSAEncryption ::= { pkcs-1 5 } */
...
#define MBEDTLS_OID_DES_EDE3_CBC                MBEDTLS_OID_RSA_COMPANY "\x03\x07" /**< des-ede3-cbc OBJECT IDENTIFIER ::= { iso(1) member-body(2)
...
#define OID_SIGNEDDATA "\x2a" "\x86" "\x48" "\x86" "\xf7" "\x0d" "\x01" "\x07" "\x02"
